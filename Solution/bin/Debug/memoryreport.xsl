...
<body>
        ...
        <h4 align="center">(The sections below are usually empty, since per-allocation memory logging is disabled by default.)</h4>
        <h4 align="center">(To enable per-allocation memory logging, see "Memory Tracking and Debugging" in "Programming for Memory Usage/Custom Allocation".)</h4>
