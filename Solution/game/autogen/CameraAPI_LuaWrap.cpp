...
#define SWIG_name      "CameraAPI"
#define SWIG_init      luaopen_CameraAPI
#define SWIG_init_user luaopen_CameraAPI_user
...
extern "C" {
#endif
static int _wrap_CurrentCamera(lua_State* L) {
  int SWIG_arg = -1;
  egf::EntityID result;
  
  SWIG_check_num_args("CameraAPI::CurrentCamera",0,0)
  result = CameraAPI::CurrentCamera();
  SWIG_arg=0;
  // egf::EntityID return value
  SWIG_arg += bapiLua::LuaTraits<egf::EntityID>::ToLuaObject(L, result);
  return SWIG_arg;
...
static const struct luaL_reg swig_commands[] = {
    { "CurrentCamera", _wrap_CurrentCamera},
    {0,0}
};
