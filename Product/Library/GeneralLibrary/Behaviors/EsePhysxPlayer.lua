...
-- author: chang qi
-- created time : 2010 -12- 10 
require("ex.math")
require("global")
require("action")
require("fsm")
module("EsePhysxPlayer", package.seeall)
...
function SetMovementTarget:exec()
     ...
     MoveDirectioneOfHorizontal =Point2.Point2(MoveDirection.x,MoveDirection.y)
       
     MoveDirectioneOfHorizontal:Unitize()
     ...
     PhysxCharacterMovementAPI.ChangeHorizontalVelocityTo(self.entity,g_TransitionTime,MoveDirectioneOfHorizontal * g_walkSpeed);
     PhysxCharacterMovementAPI.ChangeAngleTo(self.entity,g_TransitionTime * g_RotTimePercent,DirectionDegree); 
...
function SetToStop:exec()
   ...
   PhysxCharacterMovementAPI.ChangeHorizontalVelocityTo(self.entity,g_TransitionTime,Point2.Point2_ZERO);
   egmAnimation.SetTargetAnimationByName(self.entity, self.Animationname)
